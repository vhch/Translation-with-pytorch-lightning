...
now = datetime.now()
wandb_logger = WandbLogger(name=f'{now.date()}-bart', project='translation-wmt14')
...
if __name__ == "__main__":
    ...
    checkpoint_callback = pl.callbacks.ModelCheckpoint(save_top_k=5, monitor='val_bleu_score', mode='max')
    ...
    # trainer.test(model, dm, ckpt_path='/sj/test/translation/1a8wtsfm/checkpoints/epoch=22-step=25530.ckpt')
