...
# wandb_logger = WandbLogger(name=f'bart-base512-batch128-epoch100-dropout0.3-batchmean-a=10-lengthpenalty1.0', project='translation-iwslt14-rdrop')
wandb_logger = WandbLogger(name=f'batch128-epoch100-dropout0.3-sum-a=5-lengthpenalty1.0', project='translation-iwslt14-rdrop')
